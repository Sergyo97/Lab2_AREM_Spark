...
public class SparkApp {
    ...
    private static String inputDataPage(Request req, Response res) {
        String pageContent
                ...
                + "<html>"
                + "<body>"
                + "<h1>Here you can calculate mean and standard deviation upon a group of numbers</h2>"
                + "<form action=\"/results\">"
                + "  Please instert your numbers with a semicolon between them:<br>"
                + "  <input type=\"text\" name=\"Numbers\" value=\"\"> <br><br>"
                +"   For instance 3.3,4,5.5,93.9"
                + "  <br><br>"
